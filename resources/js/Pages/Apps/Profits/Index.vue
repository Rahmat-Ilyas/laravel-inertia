                            ...
                            <div class="card-body">
                                ...
                                <div v-if="profits">
                                    ...
                                    <div class="export text-end mb-3">
                                        <a :href="`/apps/profits/export?start_date=${start_date}&end_date=${end_date}&type=excel`"
                                            target="_blank" class="btn btn-success btn-md border-0 shadow me-3">
                                            <i class="fa fa-file-excel"></i> EXCEL
                                        </a>
                                        <a :href="`/apps/profits/export?start_date=${start_date}&end_date=${end_date}&type=pdf`"
                                            target="_blank" class="btn btn-secondary btn-md border-0 shadow">
